(function () {
  ...
  document.getElementById('cityContent').innerHTML = `<div class="city-intro"><div><span class="eyebrow">Metro Atlanta service area</span><h2>Junk removal in ${page[0]}, GA</h2><p>${page[1]}</p><p>Choose individual items when you know what needs to go, or use trailer-load pricing for a mixed pile. Your estimate updates before the booking step so you can request pickup with a clearer plan.</p></div><figure><img src="../photos/junk-removal/${page[2]}" alt="Household junk removal work serving ${page[0]}, Georgia" loading="lazy" decoding="async"><figcaption>Real Big Boys junk-removal work.</figcaption></figure></div><section class="local-guide"><div><span class="eyebrow muted">Plan your pickup</span><h2>How to prepare for junk removal in ${page[0]}</h2><ol><li><strong>Start with the biggest items.</strong> A couch, appliance, mattress, or bulky pile gives the clearest place to begin.</li><li><strong>Choose your pricing method.</strong> Use item pricing when your list is clear, or choose trailer space for mixed household junk.</li><li><strong>Share access details.</strong> Mention stairs, gate codes, parking, elevator access, disassembly, or a preferred pickup window.</li></ol></div><aside><h3>Need a hand with the plan?</h3><p>For a large cleanout or an item that needs extra consideration, call before you book.</p><a href="tel:+14706606874">Call (470) 660-6874</a></aside></section><h2>Popular services in ${page[0]}</h2><div class="area-dir"><a href="../services/furniture-removal.html">Furniture removal</a><a href="../services/appliance-removal.html">Appliance removal</a><a href="../services/cleanouts.html">Cleanouts</a><a href="../services/junk-removal.html">General junk removal</a></div><section class="city-faq"><span class="eyebrow muted">${page[0]} FAQs</span><h2>Questions before you book</h2><details open><summary>Can I get a price before booking?</summary><p>Yes. Start the quote experience to choose items or a load size and review an estimate before you send a pickup request.</p></details><details><summary>Do you remove items from inside?</summary><p>The crew handles the loading. Add stairs, access, parking, or other relevant details to your request so the job can be planned correctly.</p></details><details><summary>Do you offer same-day service in ${page[0]}?</summary><p>Same-day availability depends on the current schedule and route capacity. Start a quote or call us to check the earliest available option.</p></details></section><h2>Nearby Big Boys locations</h2><p>Big Boys serves Metro Atlanta from <a href="../atlanta/">Atlanta</a> and <a href="../suwanee/">Suwanee</a>. Call to confirm current route availability for your address.</p><div class="cta-row"><a class="btn btn-primary" href="../get-a-price-quote.html">Get a Price Quote</a><a class="btn btn-outline" href="tel:+14706606874">Call (470) 660-6874</a></div>`;
